...
1. 有多少被国内厂商投入了精力的 GUI App（检查点）
2. 国内发行版采用 flatpak 的程度怎么样了（采用的好，厂商开发更容易，潜力越大）。
3. chrome 默认支持视频加速了吗（支持，说明 linux 显卡相关问题已经处理好了）

如果以上问题没有解决，那么只适合虚拟机或者就是想玩 Linux。不然日常工作的效率会被大大影响。
