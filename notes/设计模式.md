...
- 用“组合”优先于用“继承”
  ...
  “组合”常用于 Has-A，“继承”常用于 Is-A（新类是不是“被继承类”的一种）

  使用“继承”的问题：

  1. 如果没有 Is-A 关系，新类可能会多出一些“多余的方法”。如：Stack extends Vector，导致可以从 Stack 的任意位置删除元素
  2. 基类的实现固定了，导致不灵活。如：假若 Set 继承 Sorting，那么排序的方法就被固定了。
